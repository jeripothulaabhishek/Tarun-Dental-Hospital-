...
export default function NotFound() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 pt-20">
      <div className="container text-center max-w-lg">
        ...
        <div className="relative inline-block mb-8">
          <svg width="120" height="140" viewBox="0 0 120 140" className="mx-auto" aria-hidden="true">
            ...
            />
            {/* Sad face on tooth */}
            <circle cx="50" cy="40" r="3" fill="#1d4ed8" opacity="0.6" />
            <circle cx="70" cy="40" r="3" fill="#1d4ed8" opacity="0.6" />
            <path d="M48 58 Q60 50 72 58" stroke="#1d4ed8" strokeWidth="2" fill="none" strokeLinecap="round" opacity="0.6" />
          </svg>
          {/* 404 badge */}
          <div className="absolute -top-2 -right-4 bg-gradient-to-br from-blue-600 to-teal-500 text-white text-xs font-black px-3 py-1 rounded-full shadow-lg">
            404
          </div>
        </div>

        <h1 className="font-black text-slate-900 dark:text-white mb-3" style={{ fontFamily: "var(--font-plus-jakarta)", fontSize: "clamp(2rem, 5vw, 3rem)" }}>
          Page Not Found
        </h1>
