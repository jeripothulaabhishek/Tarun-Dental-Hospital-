    ...
    <>
      <motion.header
        className={cn(
          ...
          scrolled
            ? "bg-[#07080c]/90 backdrop-blur-xl border-b border-amber-500/20 shadow-xl"
            : "bg-transparent"
        )}
        initial={{ y: -100 }}
        animate={{ y: 0 }}
      ...
      >
        <div className="container">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            >
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-amber-300 via-amber-500 to-yellow-600 flex items-center justify-center shadow-[0_0_15px_rgba(234,179,8,0.3)] group-hover:shadow-[0_0_25px_rgba(234,179,8,0.5)] transition-all">
              ...
              <div>
                ...
                >
                  <span className="text-amber-400">Tarun</span>{" "}
                  <span className="text-white">
                    Dental
                  </span>
                </div>
                <div className="text-[10px] font-medium text-amber-300/70 leading-none tracking-wide">
                  ...
                  >
                    ...
                    {link.children && (
                      <ChevronDown
                        size={14}
                        className={cn(
                          "transition-transform duration-200 text-amber-400",
            ...
            <div className="hidden lg:flex items-center gap-2">
              ...
              <a
                ...
                className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-sm font-medium text-slate-300 hover:text-amber-400 hover:bg-amber-500/10 transition-colors"
            ...
            <div className="flex items-center gap-2 lg:hidden">
              ...
              <button
                ...
                className="w-10 h-10 flex items-center justify-center rounded-lg text-amber-400 hover:bg-amber-500/10 transition-colors border border-amber-500/20"
